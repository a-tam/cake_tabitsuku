<nav id="globalnavi">
	...
	<?php if ($this->Session->read("user_info")): ?>
		<li class="spot"><a href="<?php echo $this->html->url("/spot/form");?>"><img src="<?php echo $this->html->url("/img/common/navi/spot.gif") ?>" alt="スポット登録"></a></li>
		<li class="tour"><a href="<?php echo $this->html->url("/tour/form");?>"><img src="<?php echo $this->html->url("/img/common/navi/tour.gif") ?>" alt="ツアー作成"></a></li>
		<li class="maypage"><a href="<?php echo $this->html->url("/user/top");?>"><img src="<?php echo $this->html->url("/img/common/navi/mypage.gif") ?>" alt="マイページ"></a></li>
	<?php else: ?>
